...
var Identity = _models2.default.Identity;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return Identity.create(req.body);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.next = 12;
            return Identity.update({ index: index }, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return Identity.findByPk(id, { include: include });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return Identity.update(req.body, {
              where: { id: id }
            });
