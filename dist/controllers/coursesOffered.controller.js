...
var Coursesoffered = _models2.default.Coursesoffered,
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return Coursesoffered.create(req.body);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            id = req.params.id;
            _context3.next = 4;
            return Coursesoffered.findByPk(id, { include: include });

          case 4:
            result = _context3.sent;
            _context3.next = 7;
            return ExpectedLearningOutcomes.findAll({
              where: { coursesofferedId: id }
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return Coursesoffered.update(req.body, {
              where: { id: id }
            });
...
//# sourceMappingURL=coursesOffered.controller.js.map