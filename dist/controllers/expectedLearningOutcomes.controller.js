...
var ExpectedLearningOutcomes = _models2.default.ExpectedLearningOutcomes;

var include = ["courses_offered", "major", "course"];
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return ExpectedLearningOutcomes.create(req.body);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            id = req.params.id;
            _context3.next = 4;
            return ExpectedLearningOutcomes.findByPk(id, { include: include });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return ExpectedLearningOutcomes.update(req.body, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return ExpectedLearningOutcomes.destroy({
              where: { id: id }
            });
...
//# sourceMappingURL=expectedLearningOutcomes.controller.js.map