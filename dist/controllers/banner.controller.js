...
var Banner = _models2.default.Banner;
...
//       res.status(200).send({
//         response_status: "ERROR",
//         message: `(ID: ${index}) was not found.`,
//       });
//       return;
//     }
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            items = req.body; // Assuming req.body contains an array of items
          ...
          case 7:
            ...
            _context2.next = 12;
            return Banner.update({ index: index }, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return Banner.findByPk(id, { include: include });
