...
var Carlendar = _models2.default.Carlendar;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return Carlendar.create(req.body);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.next = 12;
            return Carlendar.update({ index: index }, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 9;
            return Carlendar.findAll({
              order: [["index", "ASC"], ["createdAt", "DESC"]],
              where: where
            });

          case 9:
            carlendars = _context3.sent;
            _context3.next = 15;
            break;
          ...
          case 18:
            ...
            res.send({
              response_status: "ERROR",
              message: _context3.t0.message || "Some error occurred while retrieving the carlendars."
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return Carlendar.findOne({
              where: { id: id }
            });

          case 4:
            carlendar = _context4.sent;
          ...
          case 8:
            ...
            res.send({
              response_status: "ERROR",
              message: _context4.t0.message || "Some error occurred while retrieving the carlendar."
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return Carlendar.update(req.body, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            id = req.params.id;
            _context6.next = 4;
            return Carlendar.destroy({ where: { id: id } });
...
//# sourceMappingURL=carlendar.controller.js.map