...
var ThesisAndResearch = _models2.default.ThesisAndResearch;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return ThesisAndResearch.create(req.body);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.next = 12;
            return ThesisAndResearch.update({ index: index }, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            if (query.title_th) {
              where["title_th"] = (0, _defineProperty3.default)({}, Op.like, "%" + query.title_th + "%");
            }
            ...
            _context3.next = 9;
            return ThesisAndResearch.findAll({
              // limit,
              // offset,
              where: where,
              include: include,
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return ThesisAndResearch.findByPk(id, { include: include });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return ThesisAndResearch.update(req.body, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            id = req.params.id;
            _context6.next = 4;
            return ThesisAndResearch.destroy({
              where: { id: id }
            });
...
//# sourceMappingURL=thesisAndResearch.controller.js.map