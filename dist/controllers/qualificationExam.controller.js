...
var QualificationExam = _models2.default.QualificationExam;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return QualificationExam.create(req.body);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            where = query ? query : {};
            _context2.next = 7;
            return QualificationExam.findAll({
              limit: limit,
              offset: offset,
              where: where,
              include: include,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            id = req.params.id;
            _context3.next = 4;
            return QualificationExam.findByPk(id, { include: include });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return QualificationExam.update(req.body, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return QualificationExam.destroy({
              where: { id: id }
            });
...
//# sourceMappingURL=qualificationExam.controller.js.map