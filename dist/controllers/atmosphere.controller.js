...
var Atmosphere = _models2.default.Atmosphere;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return Atmosphere.create(req.body);
...
var findAll = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(req, res) {
    var query, offset, limit, page, where, resultRes, newResultRes;
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 11:
            newResultRes = resultRes.map(function (value) {
              var fileRecords = JSON.parse(value.dataValues.fileRecords) ? JSON.parse(value.dataValues.fileRecords) : [];
              var pathPic = JSON.parse(value.dataValues.pathPic) ? JSON.parse(value.dataValues.pathPic) : [];
...
var findOne = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(req, res) {
    var id, data, fileRecords, pathPic, newData;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            id = req.params.id;
            _context3.next = 4;
            return Atmosphere.findByPk(id, { include: include });
          ...
          case 8:
            fileRecords = JSON.parse(data.dataValues.fileRecords) ? JSON.parse(data.dataValues.fileRecords) : [];
            pathPic = JSON.parse(data.dataValues.pathPic) ? JSON.parse(data.dataValues.pathPic) : [];
            newData = (0, _extends3.default)({}, data.dataValues, {
              fileRecords: fileRecords,
              pathPic: pathPic
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return Atmosphere.update(req.body, {
              where: { id: id }
            });
...
//# sourceMappingURL=atmosphere.controller.js.map