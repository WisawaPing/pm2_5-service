...
var SubjectNewSubjectTypeNew = _models2.default.SubjectNewSubjectTypeNew,
    ExpectedLearningOutcomes = _models2.default.ExpectedLearningOutcomes;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return SubjectNewSubjectTypeNew.create(req.body);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            where = query ? query : {};
            _context2.next = 7;
            return SubjectNewSubjectTypeNew.findAll({
              limit: limit,
              offset: offset,
              where: where,
              include: include,
...
var findOne = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(req, res) {
    var id, result, resExpectedLearningOutcomes, data;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            id = req.params.id;
            _context3.next = 4;
            return SubjectNewSubjectTypeNew.findByPk(id, { include: include });

          case 4:
            result = _context3.sent;
            _context3.next = 7;
            return ExpectedLearningOutcomes.findAll({
              where: { subjectNewSubjectTypeNewId: id }
            });

          case 7:
            resExpectedLearningOutcomes = _context3.sent;
          ...
          case 11:
            data = (0, _extends3.default)({}, result.dataValues, {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return SubjectNewSubjectTypeNew.update(req.body, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return SubjectNewSubjectTypeNew.destroy({
              where: { id: id }
            });
...
//# sourceMappingURL=subjectNewSubjectTypeNew.controller.js.map