...
var KnowledgeTest = _models2.default.KnowledgeTest;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return KnowledgeTest.create(req.body);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            id = req.params.id;
            _context3.next = 4;
            return KnowledgeTest.findByPk(id, { include: include });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return KnowledgeTest.update(req.body, {
              where: { id: id }
            });
...
//# sourceMappingURL=knowledgeTest.controller.js.map