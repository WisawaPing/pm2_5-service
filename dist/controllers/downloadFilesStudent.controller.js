...
var DownloadFilesStudent = _models2.default.DownloadFilesStudent;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return DownloadFilesStudent.create(req.body);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.next = 12;
            return DownloadFilesStudent.update({ index: index }, {
              where: { id: id }
            });
...
var findAll = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(req, res) {
    var query, downloadFilesStudents, where;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 9;
            return DownloadFilesStudent.findAll({
              order: [["index", "ASC"]],
              where: where
            });

          case 9:
            downloadFilesStudents = _context3.sent;
            _context3.next = 15;
            break;
          ...
          case 18:
            ...
            res.send({
              response_status: "ERROR",
              message: _context3.t0.message || "Some error occurred while retrieving the downloadFilesStudents."
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return DownloadFilesStudent.findOne({
              where: { id: id }
            });

          case 4:
            downloadFilesStudent = _context4.sent;

            res.send({
              response_status: "SUCCESS",
              data: downloadFilesStudent.dataValues
            });
            _context4.next = 11;
            break;
          ...
          case 8:
            ...
            res.send({
              response_status: "ERROR",
              message: _context4.t0.message || "Some error occurred while retrieving the downloadFilesStudent."
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return DownloadFilesStudent.update(req.body, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            id = req.params.id;
            _context6.next = 4;
            return DownloadFilesStudent.destroy({ where: { id: id } });
...
//# sourceMappingURL=downloadFilesStudent.controller.js.map