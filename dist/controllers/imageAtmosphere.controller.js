...
var ImageAtmosphere = _models2.default.ImageAtmosphere;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return ImageAtmosphere.create(req.body);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.next = 12;
            return ImageAtmosphere.update({ index: index }, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            where = query ? query : {};
            _context3.next = 7;
            return ImageAtmosphere.findAll({
              limit: limit,
              offset: offset,
              where: where,
              include: include,
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return ImageAtmosphere.findByPk(id, { include: include });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return ImageAtmosphere.update(req.body, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            id = req.params.id;
            _context6.next = 4;
            return ImageAtmosphere.destroy({
              where: { id: id }
            });
...
//# sourceMappingURL=imageAtmosphere.controller.js.map