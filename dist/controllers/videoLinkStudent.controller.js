...
var VideoLinkStudent = _models2.default.VideoLinkStudent;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return VideoLinkStudent.create(req.body);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 7;
            return VideoLinkStudent.findAll({
              // order: [
              //   [ 'createdAt', 'DESC' ],
              // ],
              where: where
          ...
          case 7:
            videoLinkStudents = _context2.sent;
            _context2.next = 13;
            break;
          ...
          case 16:
            ...
            res.send({
              response_status: "ERROR",
              message: _context2.t0.message || "Some error occurred while retrieving the videoLinkStudents."
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            id = req.params.id;
            _context3.next = 4;
            return VideoLinkStudent.findOne({
              where: { id: id }
            });

          case 4:
            videoLinkStudent = _context3.sent;
          ...
          case 8:
            ...
            res.send({
              response_status: "ERROR",
              message: _context3.t0.message || "Some error occurred while retrieving the videoLinkStudent."
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return VideoLinkStudent.update(req.body, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return VideoLinkStudent.destroy({ where: { id: id } });
...
//# sourceMappingURL=videoLinkStudent.controller.js.map