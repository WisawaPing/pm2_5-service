...
var Scholarship = _models2.default.Scholarship,
    DocumentScholarship = _models2.default.DocumentScholarship;
    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.next = 6;
            return Scholarship.create(req.body);
          ...
          case 15:
            ...
            _context.next = 20;
            return DocumentScholarship.create(documentScholarship);
          ...
          case 37:
            _context.next = 39;
            return DocumentScholarship.findAll({
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            _context2.next = 12;
            return Scholarship.update({ index: index }, {
              where: { id: id }
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = req.params.id;
            _context4.next = 4;
            return Scholarship.findByPk(id, { include: include });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            id = req.params.id;
            _context5.next = 4;
            return Scholarship.update(req.body, {
              where: { id: id }
            });
          ...
          case 9:
            _context5.next = 11;
            return DocumentScholarship.destroy({ where: { scholarshipId: id } });
